...
<form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-12 mb-3">
            ...
            <input type="text" id="product_name" name="product_name" value="{{ $product->product_name }}" class="form-control" placeholder="商品名を入力" >
            @error('product_name')
        ...
        <div class="col-12 mb-3">
            ...
            <input type="number" id="price" name="price" value="{{ $product->price }}" class="form-control" placeholder="価格を入力" >
            @error('price')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="col-12 mb-3">
            ...
            <input type="number" id="stock" name="stock" value="{{ $product->stock }}" class="form-control" placeholder="在庫数を入力" >
            @error('stock')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
